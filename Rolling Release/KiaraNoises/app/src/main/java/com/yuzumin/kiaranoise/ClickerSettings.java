...
public class ClickerSettings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        KiaraIMG=findViewById(R.id.kiara_img);
        KiaraIMGRow =findViewById(R.id.kiara_img_row);
        ...
        KiaraIMG.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        KiaraIMGRow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                charavalue=0;
                SoundSettingsEditor =getSharedPreferences("Chara",MODE_PRIVATE).edit();
